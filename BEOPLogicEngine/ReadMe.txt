========================================================================
    控制台应用程序：BEOPGatewayCore 项目概述
========================================================================

应用程序向导已为您创建了此 BEOPGatewayCore 应用程序。

本文件概要介绍组成 BEOPGatewayCore 应用程序的每个文件的内容。


BEOPGatewayCore.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 
    的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

BEOPGatewayCore.vcxproj.filters
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 BEOPGatewayCore.pch 的预编译头 (PCH) 文件和
